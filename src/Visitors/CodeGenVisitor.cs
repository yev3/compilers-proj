// Visitors for IL code generation
...
namespace CompilerILGen.Visitors
{
    ...
    public class CodeGenVisitor
    {
        ...
        private void VisitNode(ParamList plist)
        {
            ...
            if (paramList != null)
            {
                ...
                string insideParen = string.Join(", ",
                    paramList.Select(p => (p.DeclTypeNode.NodeTypeCategory.GetIlName())));
