 ...
 where TSpan : IMerge<TSpan>, new()
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        protected TSpan CurrentLocationSpan = new TSpan();
...
#endif
    {
        ...
        //public string CurrentLine { get { return buffer.GetString()} }


        public override string ToString()
        {
            return this.buffer.GetString(tokPos, tokEPos);
        }
        ...
        public LexLocation(int sl, int sc, int el, int ec, int tokPos, int tokEPos, ScanBuff buffer) : this(sl, sc, el, ec)
        {
            this.tokPos = tokPos;
            this.tokEPos = tokEPos;
            this.buffer = buffer;
        }
        ...
        {
            return new LexLocation(this.startLine, this.startColumn, last.endLine, last.endColumn, this.tokPos, last.tokEPos, buffer);
        }
    }
...
#pragma warning restore 649
        ...
        // Reason for FxCop message suppression -
        // This is a traditional name for YACC-like functionality
        private TSpan _yylloc = new TSpan();
